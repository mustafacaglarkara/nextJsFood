        ...
        after:absolute after:top-0 after:left-0 after:opacity-60 grid place-content-center">
            <OutsideClickHandler onOutsideClick={()=>{
                ...
                <div className="w-full h-full grid place-content-center relative ">
                    <div className="relative z-50 w-[600px] h-[600px] bg-white border-2 p-5 rounded-2xl shadow-2xl">
                        <Title addClass="text-[40px] text-center">Search</Title>
                        <input type="text" placeholder="Arama..." className="border w-full my-10"/>
                        <ul>
                      ...
                      <button className="absolute top-4 right-4" onClick={()=>{
                          ...
                          <GiCancel size={25} className="text-primary hover:text-secondary transition-all"/>
                      </button>
                    </div>
                </div>
